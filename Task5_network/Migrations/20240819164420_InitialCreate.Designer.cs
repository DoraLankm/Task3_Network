...
namespace ConsoleApp21.Migrations
{
    ...
    [Migration("20240819164420_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsoleApp21.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ConsoleApp21.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ConsoleApp21.Models.Message", b =>
                {
                    b.HasOne("ConsoleApp21.Models.User", "FromUser")
                        .WithMany("FromMessages")
                        .HasForeignKey("FromUserId")
                        .HasConstraintName("messages_from_user_id_fkey");

                    b.HasOne("ConsoleApp21.Models.User", "ToUser")
                        .WithMany("ToMessages")
